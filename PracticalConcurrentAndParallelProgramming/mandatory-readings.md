# Mandatory reading (“pensum”) for the examination in Practical Concurrent and Parallel Programing (PCPP) F2025
...
- Staunstrup and Pardo
  * [The concurrency note](https://github.itu.dk/jst/PCPP2025-Public/blob/main/week01/concurrency-note/concurrencyPCPP.pdf), up to section "Safety"
</details>
...
- Pardo:
  * [The Java Memory Model (for PCPP)](https://github.itu.dk/jst/PCPP2025-Public/blob/main/week03/java_memory_model_lecture_notes.pdf).
...
- Staunstrup and Pardo
  * [The concurrency note](https://github.itu.dk/jst/PCPP2025-Public/blob/main/week01/concurrency-note/concurrencyPCPP.pdf). Section "Linearizability", complete.
...
- Peter Sestoft:
  - [Microbenchmarks in Java and C sharp](https://github.itu.dk/jst/PCPP2025-Public/blob/main/week09/benchmarkingNotes.pdf). Except for sections 9-12.
...
- [Thread Pools](https://www.baeldung.com/thread-pool-java-and-guava) (up to section 4 (Guava))
...
- Peter Sestoft. [Java Precisely 3rd edition](https://github.itu.dk/jst/PCPP2025-Public/blob/main/week11/reading-material/javaprecisely-3rd-draft-streams.pdf):
  * Sections 24 and 25.
...
- [Section II of the concurrency note](https://github.itu.dk/jst/PCPP2025-Public/blob/main/week12/concurrency-note/concurrency2.pdf)

- [Oracle's documentation of Network communication in Java](https://docs.oracle.com/javase/tutorial/networking/overview/networking.html)
